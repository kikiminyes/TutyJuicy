-- Migration: Fix column name mismatch
-- Run this in Supabase SQL Editor

-- Your database uses 'total_amount' but the function uses 'total_price'
-- This migration updates the function to use 'total_amount'
...
declare
    ...
    v_price numeric;
begin
    -- Create order (using total_amount to match your database schema)
