-- Migration: Fix create_order_atomic to use total_price
-- This overrides the previous migration that used total_amount incorrectly
...
declare
    ...
    v_price numeric;
begin
    -- Create order using total_price
